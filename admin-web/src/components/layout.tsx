...
const NAV = [
  ...
  { to: "/catalog/overview", label: "总库概览", icon: Gauge },
  { to: "/catalog/search", label: "总库检索", icon: BookOpen },
  { to: "/catalog/acquisitions", label: "全局获取池", icon: DownloadCloud },
  { to: "/catalog/imports", label: "导入中心", icon: UploadCloud },
  { to: "/catalog/quality", label: "数据质量", icon: Sparkles },
  ...
  { to: "/books", label: "历史图书", icon: BookOpen },
  { to: "/tasks", label: "历史任务", icon: ListChecks },
